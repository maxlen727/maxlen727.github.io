...
按照常规操作解BL，进fastboot，刷Rec（用的OrangeFox），adbsideload侧载rom，开机
...
这次的dotos就还可以了，也不能开机，但是可以显示一个报错的界面，全英文，具体是什么我也忘了，就是说需要格式化此设备才行，下面直接一个按钮Reboot to Recovery。
