...
我有一块小米手环3，貌似是16年买的，用到了2022年，服役时间够久了，使用时间也超过了设计使用年限（5年）。本来我是准备用到坏的，但是我这个人比较喜欢折腾。手机能刷机，其实手环也能“刷环”。因为3代和2代手环功能上都比较单一，表盘就只有两三个，用久了肯定会审美疲劳的。不过刷环后可以使手环的界面不一样，发生一些变化，并且用腻了可以再换一个资源包。
...
> 刷环其实分为两种。首先是换系统，这会涉及到底层，这类固件包可以为手环增加一些新功能，比如日历之类的，但是如果失败就会变成黑砖了。还有一种刷环是换资源包，就只是单纯的界面上的变化，这类资源包没刷上还可以救一下。

我乱折腾把手环上的所有功能都隐藏了，包括恢复出厂设置的功能。其实这个功能位于“更多”中，正常去在手机APP上拖动功能块确实是无法隐藏的，但是偶然发现有一个Bug：点击功能块旁边的减号就可以隐藏。于是我就隐藏了，它彻底变成了一块表——只能看时间的表。

后来又想将功能恢复，结果连不上了，我准备解绑后重新绑定一下。

结果我忘记了我开了限制绑定（即只有恢复出厂设置后才可绑定设备），但是恢复出厂设置的功能被隐藏了！我咨询了小米客服，翻了米坛社区，去找了国外的Geek论坛，都不能解决。于是这块表四舍五入就等于废了——只能看时间，甚至无法校准时间的表。

### 欲换环7却落入Pro圈套

暑假我准备换一块表，本来是不希望买小米产品了，结果听说7增加了息屏显示，这点真的戳我！于是我又将目光放到了小米身上。本来是准备要买7，但当天官方就放出了Pro的预告“时尚新选择”，不成想这是甜蜜的陷阱。
...
我就是这么想的，但是第二天我去了小米专卖店去查看情况。发现小米手环7是非常之卡顿（展示机的固件版本没升级，据说升级之后会流畅不少，但是当时并不清楚这一情况）。转手又摸了摸7Pro，哇，好流畅啊，并且感觉到屏幕大就是爽！我又对7Pro动了心，并且这可是带Pro字样的！总不可能反向升级吧？于是买了Pro带走了。

### 前期使用，也算顺心

买到之后我直接当场在小米店里开始了绑定。首次开机需要充电激活，直接就地拿来了店里的充电宝，给手环进行了激活。
...
4. 支持离线支付：我经常出门不带手机，离线支付真的很方便。
5. 手电筒：宿舍神器，学生朋友们应该都懂。
...
我不知道Pro不是华米代工的啊！由于不是华米代工，所以没有Zeep OS. 失去的功能有：动态表盘、JS小程序、PAI, 等等，等等，更多，更多。

再说Zeep Life是华米的，那这个Pro不支持Zeep Life就是顺理成章了。但是小米运动健康它Bug奇多！这个我下面慢慢说~

### 发布会没说的

下面看一下发布会的宣传页，来吐槽一下小米手环7Pro为什么不Pro。
...
OK，先说这个宣传的金属质感中框，说是金属质感，其实就是塑料。
...
首先是百款表盘其实不太好看，能看的没几个。然后是相册表盘，默认字体颜色是白色的，不能修改，这就导致一大堆浅色图片不能用了，根本看不清。你想自定义第三方表盘吗？对不起，不行！米坛社区开发组已经深入研究过了，这东西的开放程度...基本无解。还有息屏显示的表盘，默认的是指针，没有数字，根本看不出来具体几点，并且支持息屏显示的表盘不多。
...
这个快拆设计真的是卡得太紧了，是难拆设计。

运动相关功能

117种运动模式，很棒，个别运动模式有特别优化。比如跑步有GPS，跳绳可以记录你跳了多少个。

10种跑步课程，这个也算是卖点吧。有专业的运动安排：心率达不到目标心率让你加速，超过目标心率提醒你减速，帮你更好地运动。
...
我模拟了我的饭卡（是加密卡）它提示模拟成功，但我猜是不能用的，开学后试试。
...
1. 全面健康管理：比较没用的功能，压力检测和血氧检测只能静止时测，还费电。就是心率检测在心率过高过低时发出提醒可能有点用
2. 自动调节屏幕亮度：这个很好，比较灵敏。阳光下看得见，黑暗里又不会亮瞎眼。
3. 续航：说的是12天，我不清楚这是什么模型测出来的啊，实际使用很差。实测我每天早上GPS使用1小时，心率智能检测，不开AOD，不开压力血氧，抬碗亮屏开启，续航3天。或者说每天早上不运动，续航5天。或者说每天运动但开AOD，续航2天。或者说每天不运动但开AOD，续航3天。或者说不运动，不AOD，不抬碗亮屏，6天。
...
1. 小米运动健康Bug奇多，一个很经典的是：MIUI手机数据显示同步成功但首页看不见数据（测试MIUI版本为MIUI11），非MIUI手机可以看到数据但偶尔同步失败
...
120种运动模式比Pro多3种，续航宣传15天比Pro宣传的12天多三天，表盘比Pro好看还有第三方开发者做的表盘。
...
UI比Pro好看，功能比Pro多，细节比Pro好

动画

Zeep OS有动态表盘，有JS小程序，Pro都没有。

AOD

AOD息屏显示比Pro样式多比Pro好看。
